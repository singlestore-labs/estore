...
export function Dots({ className, ...props }: DotsProps) {
  return (
    <span
      {...props}
      className={cn(
        "absolute left-1/2 top-1/2 -z-10 w-full -translate-x-1/2 -translate-y-1/2 overflow-hidden text-black/10 after:pointer-events-none after:block after:pt-[100%]",
        className,
      )}
    >
